...
CREATE TABLE `song_list`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID（序号）',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '歌单' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of song_list
-- ----------------------------
INSERT INTO `song_list` VALUES (1, 'SLEEPWALK', 'ヒトリエ', '2', '3,6,5', '131', '1', NULL, '2', '测试', NULL);
INSERT INTO `song_list` VALUES (2, 'フユノ(冬野)', 'ヒトリエ', '2', '1,3,4,5,6', '30', '2', '{\"createBy\":null,\"createTime\":null,\"updateBy\":null,\"updateTime\":null,\"remark\":null,\"name\":\"告白花束\",\"price\":\"19.9\",\"icon\":\"https://s1.hdslb.com/bfs/live/a4aa89aaa24534cb77534680eaed1f5f2f9aa71f.png\",\"value\":24}', '2', 'フユノ(冬野)', NULL);
INSERT INTO `song_list` VALUES (3, '日常と地球の額縁 (日常和地球的画框)', 'ヒトリエ', '2', '3,6', '500', '3', '{\"name\":\"舞台天王\",\"price\":\"666.6\",\"icon\":\"https://s1.hdslb.com/bfs/live/7636ca1a0ab5ed2d1b639044655164987e8d3510.png\",\"value\":63}', '1', '日常と地球の額縁 (日常和地球的画框)', NULL);
INSERT INTO `song_list` VALUES (4, '普通用户测试-歌名', '普通用户测试-歌手', '1', '1,2,4,6', '257', '1', '{\"name\":\"梦幻游乐园\",\"price\":\"3000.0\",\"icon\":\"https://s1.hdslb.com/bfs/live/f1ed9d627f75b46fe621558951847e0e4e95d6a2.png\",\"value\":73}', '1', '普通用户测试-备注', '2');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '超级管理员', '00', '18888888888@163.com', '18888888888', '0', '/profile/avatar/2026/03/04/febd20c35da54d7dad736e3aeb3377a6.png', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-03-04 13:07:54', '2026-02-24 20:59:01', 'admin', '2026-02-24 20:59:01', '', '2026-03-04 15:04:30', '管理员');
